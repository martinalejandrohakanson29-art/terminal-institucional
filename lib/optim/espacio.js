...
function reparar(cfg) {
    ...
    // Sin ningún lado habilitado no hay estrategia. Se prenden los DOS: es la reparación
    // simétrica (elegir uno sesgaría la búsqueda hacia ese lado, porque la combinación
    // apagada-apagada sale en 1 de cada 4 sorteos) y además es determinística — un sorteo
    // acá rompería la reproducibilidad del estudio entero.
